...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<form onsubmit=\"javascript: return false;\" class=\"form-search\">\n\n\n    <div class=\"form-group\">\n        <label for=\"ngremotemedia-remote-media-type-select\">"
    ...
    + "</option>\n            <option value=\"all\">"
    + escapeExpression((helper = helpers.translate || (depth0 && depth0.translate),options={hash:{},data:data},helper ? helper.call(depth0, "All", options) : helperMissing.call(depth0, "translate", "All", options)))
...
function program3(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "<br />\n    <small>";
  if (helper = helpers.possibleWidth) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.possibleWidth); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "x";
  if (helper = helpers.possibleHeight) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.possibleHeight); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</small>\n</a>\n";
  return buffer;
  });
